...
import { ArrowLeft, Percent, Car, CalendarClock, Download } from 'lucide-react';
                    ...
                    <div className="xl:col-span-5 space-y-6">
                        <div>
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400 text-xs font-extrabold mb-4 uppercase tracking-wide">
                                <Car className="w-3 h-3" /> Loan Planner
                            </div>
                            <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-3 tracking-tight">Car Loan EMI</h1>
                            <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                                Drive your dream car. Plan your loan repayment with ease.
                            </p>
                        </div>
