...
import { ArrowLeft, Percent, Building2, CalendarClock, Download, Coins } from 'lucide-react';
            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
                    ...
                    <div className="xl:col-span-5 space-y-6">
                        <div>
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400 text-xs font-extrabold mb-4 uppercase tracking-wide">
                                <Coins className="w-3 h-3" /> Personal Finance
                            </div>
                            <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-3 tracking-tight">Personal Loan EMI</h1>
                            <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                                Plan your personal loan repayment. Calculate EMI and total interest payable.
                            </p>
                        </div>
                    ...
                    <div className="xl:col-span-7">
                        <div className="bg-gradient-to-br from-rose-500 to-orange-600 rounded-[2.5rem] p-8 sm:p-10 text-white shadow-2xl shadow-rose-500/30 relative overflow-hidden transition-all duration-500 hover:shadow-rose-500/40 hover:scale-[1.01]">
                ...
                <div className="mt-20 max-w-3xl mx-auto">
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Personal Loan EMI Calculator</h2>
                    <p className="text-slate-600 dark:text-slate-400">
                        A personal loan is an unsecured loan that you can use for various purposes, such as medical emergencies, travel, or debt consolidation.
                        Use this calculator to determine your monthly Equated Monthly Installment (EMI) based on the loan amount, interest rate, and tenure.
                    </p>
                </div>
            </div>
        </div>
